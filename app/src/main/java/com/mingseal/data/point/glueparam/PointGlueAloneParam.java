...
public class PointGlueAloneParam extends PointParam {
     ...
     * @param nDipDistanceY
     */
    public void setnDipDistanceY(int nDipDistanceY) {
        this.nDipDistanceY = nDipDistanceY;
    }
     ...
     * @return 获取y轴倾斜距离
     */
    public int getnDipDistanceY() {
        return nDipDistanceY;
    }
     ...
     * @param nDipDistanceZ
     */
    public void setnDipDistanceZ(int nDipDistanceZ) {
        this.nDipDistanceZ = nDipDistanceZ;
    }
     ...
     * @return 获取z轴倾斜距离
     */
    public int getnDipDistanceZ() {
        return nDipDistanceZ;
    }
     ...
     * @param nDipSpeed
     */
    public void setnDipSpeed(int nDipSpeed) {
        this.nDipSpeed = nDipSpeed;
    }
    ...
    public static final Parcelable.Creator<PointGlueAloneParam> CREATOR = new Creator<PointGlueAloneParam>() {
        ...
        public PointGlueAloneParam createFromParcel(Parcel source) {
            ...
            point.gluePort = val;
            point.nDipDistanceY = source.readInt();
            point.nDipDistanceZ = source.readInt();
            point.nDipSpeed = source.readInt();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(nDipDistanceZ);
        dest.writeInt(nDipSpeed);
