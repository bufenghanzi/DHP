...
import com.mingseal.view.SwipeMenuView.OnSwipeItemClickListener;
 ...
 *	
 */
public class SwipeMenuAdapter implements SpinnerAdapter,
    ...
    public SwipeMenuAdapter(Context context, SpinnerAdapter adapter) {
        mAdapter = adapter;
        mContext = context;
    }
