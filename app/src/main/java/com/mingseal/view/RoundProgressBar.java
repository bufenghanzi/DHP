...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		// 获取自定义属性和默认值
		roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundColor, Color.rgb(255, 113, 33));
		roundProgressColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundProgressColor,
				Color.rgb(38, 166, 154));
		textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_textColor, Color.rgb(38, 166, 154));
